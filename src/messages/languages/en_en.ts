export const en_en = {
    ...
    EMERGENCY_MEETING_REQUESTED_BY: "Meeting requested by {color}",
    EMERGENCY_MEETING_REQUESTED_BY_SUBTITLE: "Requester name: {requester}",
    DEAD_BODY_FOUND_BY: "{color} body found by {requesterColor}",
    DEAD_BODY_FOUND_BY_SUBTITLE: "Reporter name: {requester}",
    ...
    KNIFE_READY: "Knife ready - Press F to use",
    KNIFE_READY_VISIBLE: "Knife ready - Press F to hide",
